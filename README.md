...
* **Eğitim:** Caesar, Vigenère gibi klasik yöntemlerden, AES, RSA gibi modern standartlara sahip algoritmaların görsel olarak anlaşılmasını sağlamak.
...
* **Geniş Algoritma Kütüphanesi:**
    ...
    * **Klasik/Yer Değiştirme:** Caesar, Vigenère
    * **Matematiksel/Matris:** Hill Cipher
